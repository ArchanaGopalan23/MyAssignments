...
public class CreateNewCaller extends ProjectCommonMethod{
	...
	public void createNewCaller() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id='sys_user.first_name']")).sendKeys("Robert");
		driver.findElement(By.xpath("//input[@id='sys_user.last_name']")).sendKeys("John");
		driver.findElement(By.xpath("//input[@id='sys_user.email']")).sendKeys("John@abc.com");
		driver.findElement(By.xpath("//input[@id='sys_user.phone']")).sendKeys("45");
		driver.findElement(By.xpath("//input[@id='sys_user.title']")).sendKeys("Mr");
		driver.findElement(By.xpath("//input[@id='sys_user.mobile_phone']")).sendKeys("99");
		driver.findElement(By.xpath("//button[@class='form_action_button  action_context btn btn-default']")).click();
		driver.findElement(By.xpath("//input[@class='form-control']")).sendKeys("Robert",Keys.ENTER);
		driver.findElement(By.xpath("//table[@id='sys_user_table']/thead/tr[2]/td[3]//div//input")).sendKeys("John");
		driver.findElement(By.xpath("//table[@id='sys_user_table']/thead/tr[2]/td[4]//div//input")).sendKeys("Robert",Keys.ENTER);
